...
#define VBG_VOLTAGE (1200) /* 1.20V = 1200 mV (Typical band-gap voltage of NUC029xDE series) */
...
int main(void)
{
    ...
    /*------------------------------------------------------------------------------------------------------------------
       ...
       Note 1 : The measured AVDD has deviation that causes by the band-gap voltage has deviation in different temperature, power voltage and ADC conversion deviation.(4 LSB)
                ...
                The Spec. of band-gap voltage in NUC029xDE series is as follows:
                -----------------------------------------------------------------------------------------
                |                  | Min.   | Typ.   | Max.   |                                         |
                |                  |--------------------------- VDD = 2.5 V ~ 5.5 V                     |
       ...
       Note 2: In this sample code is using the typical value of NUC029xDE series: 1.20 V, and it can be modified by VBG_VOLTAGE definition.
