 ...
 * @return      None
 *
 * @details     The External INT0(PB.14) default IRQ, declared in startup_NUC029xDE.s.
 */
 ...
 * @return      None
 *
 * @details     The External INT1(PB.15) default IRQ, declared in startup_NUC029xDE.s.
 */
